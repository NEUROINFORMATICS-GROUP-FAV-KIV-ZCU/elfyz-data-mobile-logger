...
public class WSManufacturerSpecificListFragment extends ADataListFragment {
  ...
  private static final String EXPERIMENT_PARAMETER_NAME = "WS Manufacturer Specific";
  ...
  protected IExperimentParametersUploadHelper getUploadHelper(long[] selected) {
    return new WSManufacturerSpecificDataDbUploadHelper(EXPERIMENT_PARAMETER_NAME, 0.0, selected, true);
  }
